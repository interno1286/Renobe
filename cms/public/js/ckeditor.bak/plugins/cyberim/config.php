...
include("../../../../../../site/settings/config.php");
/*
  General options
*/
...
$conf['filesystem.path'] = $config['url']['base'].'public/editor_upload/';
//относительный путь к файлам пользователя
$conf['filesystem.files_path'] = '../../../../../../public/editor_upload/';
