...
*}
    ...
    <body>
        <form id="edit_page_form" onsubmit="return false;">
            ...
            <nav class="navbar navbar-default navbar-form" role="navigation">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <button class="btn btn-danger navbar-btn" onclick="saveTpl('{$params.tpl|default:''}');">сохранить</button>
                        <button class="btn btn-info navbar-btn" onclick="previewTpl('{$params.tpl|default:''}');">предпросмотр</button>
            ...
            <textarea name="content" id="content">{$file_content}</textarea>
